#!/bin/bash
# GPS-Z ON rerun — Fly3 — global_yaw_oc_projection alpha=1.0 + GPS-Z guard
set -euo pipefail
export DISPLAY=:0
...
FC_INIT=/mnt/c/Users/baloney/Desktop/20260527_gsmq_d455_fly3/result/fc_rebuild_20260527/canonical_offset438p0_start618/fc_init_state_618_offset438p0.csv
OUT=/mnt/c/Users/baloney/Desktop/20260527_gsmq_d455_fly3/result/gpsz_on_rerun_fly3_global_oc_guarded

mkdir -p "$OUT"

echo "=== FLY3 GPS-Z ON RERUN ===" | tee "$OUT/log.txt"
