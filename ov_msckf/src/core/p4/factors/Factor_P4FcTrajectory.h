/* Correlated FC attitude/position/velocity trajectory factor for formal P4. */
...
/**
 * The FC output error state is e=[dtheta, dp, dv] with Phi=I.  Its first-row
 ...
 * P_terminal.
 *
 * Residual order is [terminal absolute PVA, chronological PVA increments].
 ...
 * are never installed as independent Ceres residual blocks.
 */
...
private:
  ...
  std::vector<Eigen::Matrix3d> target_R_GtoI_;
